export const GOJO_ANIMATIONS = {
  ...
  m1_1: { row: 1, frames: 3, speed: 10, loop: false },
  m1_2: { row: 2, frames: 3, speed: 10, loop: false },
  m1_3: { row: 3, frames: 3, speed: 10, loop: false },
  m1_4: { row: 4, frames: 3, speed: 10, loop: false },
