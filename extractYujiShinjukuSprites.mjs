...
const SFF_PATH = "C:\\Cursed Battles\\client\\Jujutsu Kaisen Mugen V9 (OpenGL)\\chars\\Itadori Shinjuku\\sff.sff";
const BASE_DIR = "C:\\Cursed Battles\\Yuji_Sprites\\Yuji Base";
...
async function main() {
  ...
  console.log("Reading Yuji Shinjuku SFF...");
  ...
  console.log("\nScanning Yuji Base for viewer data...");
...
<head>
<meta charset=UTF-8>
<title>Yuji Shinjuku - Sprites Viewer</title>
<style>
...
if (groupIds.length > 0) showGroup(groupIds[0]);
  ...
  const viewerPath = "C:\\Cursed Battles\\Yuji_Sprites\\viewer.html";
