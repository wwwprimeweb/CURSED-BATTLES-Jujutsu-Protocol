...
const SFF_PATH = "C:\\Cursed Battles\\client\\Jujutsu Kaisen Mugen V9 (OpenGL)\\chars\\Panda Senpai\\Sprite.sff";
const BASE_DIR = "C:\\Cursed Battles\\Panda_Sprites\\Panda Base";
...
async function main() {
  ...
  console.log("\nScanning Panda Base for viewer data...");
...
<head>
<meta charset=UTF-8>
<title>Panda - Sprites Viewer</title>
<style>
...
if (groupIds.length > 0) showGroup(groupIds[0]);
  ...
  const viewerPath = "C:\\Cursed Battles\\Panda_Sprites\\viewer.html";
